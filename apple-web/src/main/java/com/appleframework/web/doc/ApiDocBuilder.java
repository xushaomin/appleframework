...
import com.appleframework.web.bean.Api;
import com.appleframework.web.bean.DefinitionHolder;
import com.appleframework.web.doc.annotation.ApiDoc;
import com.appleframework.web.doc.annotation.ApiDocBean;
import com.appleframework.web.doc.annotation.ApiDocField;
import com.appleframework.web.doc.annotation.ApiDocMethod;
import com.appleframework.web.doc.annotation.ApiDocReturn;
import com.appleframework.web.doc.annotation.ApiDocRootData;
...
public class ApiDocBuilder {
    ...
    protected ApiDocFieldDefinition buildApiDocFieldDefinitionByClass(ApiDocField docField, Class<?> clazz, Field field) {
        ...
        String type = docField.dataType() != DataType.UNKNOW
                ? docField.dataType().getValue()
                : DataType.OBJECT.getValue();
