...
import com.appleframework.web.auth.OpenUser;
...
public class ApiContext {
    ...
    private static final String ATTR_STANDARD_MODE = "easyopen-standard-mode";
    ...
    public static void setMsg(String msg) {
        setAttr(ATTR_MSG, msg);
    }

    public static String getMsg() {
        return String.valueOf(getAttr(ATTR_MSG));
    }
    ...
    public static boolean isStandardMode() {
    	HttpServletRequest request = getRequest();
     	...
     	String mode = request.getHeader(ATTR_STANDARD_MODE);
     	if(null != mode && mode.equalsIgnoreCase("true")) {
     		return true;
     	}
     	else {
     		if(apiConfig.isStandardMode()) {
     			return true;
     		}
     		else {
     			return false;
