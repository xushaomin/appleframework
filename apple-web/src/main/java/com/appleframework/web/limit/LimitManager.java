package com.appleframework.web.limit;
...
public interface LimitManager {
    ...
    /**
     * 从令牌桶中获取令牌，如果使用{@link com.appleframework.web.limit.LimitType#TOKEN_BUCKET
    ...
    /**
     * 是否需要限流，如果使用{@link com.appleframework.web.limit.LimitType#LIMIT
