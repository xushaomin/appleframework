package com.appleframework.tools.date;

import com.appleframework.tools.collection.CollUtil;
import com.appleframework.tools.comparator.CompareUtil;
import com.appleframework.tools.convert.Convert;
import com.appleframework.tools.date.format.DateParser;
import com.appleframework.tools.date.format.DatePrinter;
import com.appleframework.tools.date.format.FastDateFormat;
import com.appleframework.tools.lang.Assert;
import com.appleframework.tools.lang.PatternPool;
import com.appleframework.tools.util.CharUtil;
import com.appleframework.tools.util.NumberUtil;
...
public class DateUtil extends CalendarUtil {
	...
	public static String nowMs() {
		return formatMsDateTime(new DateTime());
	}
	...
	public static String formatMsDateTime(Date date) {
		...
		return DatePattern.NORM_DATETIME_MS_FORMAT.format(date);
	}
