 ...
 * @since 1.0
 * @version $Id: StringUtil.java 635447 2008-03-10 06:27:09Z bayard $
 */
public class StringUtil {
    ...
    public static String chop(String str) {
        ...
        char last = str.charAt(lastIdx);
        if (last == CharUtil.LF) {
            if (ret.charAt(lastIdx - 1) == CharUtil.CR) {
     ...
     * That functionality is available in WordUtil.</p>
     *
    ...
    public static boolean isAsciiPrintable(String str) {
        ...
        int sz = str.length();
        for (int i = 0; i < sz; i++) {
            if (CharUtil.isAsciiPrintable(str.charAt(i)) == false) {
                return false;
            }
        }
        return true;
