...
import com.appleframework.logging.AbstractLog;
...
import com.appleframework.tools.lang.Dict;
...
public class ConsoleLog extends AbstractLog {
	...
	private static final String logFormat = "###|||{date}|||{level}|||-|||-|||{thread}|||{name}--->{msg}";
