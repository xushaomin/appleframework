...
public class GlobalLogFactory {
	 ...
	 * 自定义日志实现
	 * 
	 * @see com.appleframework.logging.dialect.slf4j.Slf4jLogFactory
	 * @see com.appleframework.logging.dialect.log4j.Log4jLogFactory
	 * @see com.appleframework.logging.dialect.log4j2.Log4j2LogFactory
	 * @see com.appleframework.logging.dialect.commons.ApacheCommonsLogFactory
	 * @see com.appleframework.logging.dialect.jdk.JdkLogFactory
	 * @see com.appleframework.logging.dialect.console.ConsoleLogFactory
	 * 
